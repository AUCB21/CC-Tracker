...
export function ThemeToggle({ compact = false, className = "" }: { compact?: boolean; className?: string }) {
  ...
  return (
    <button
      ...
      className={className || "inline-flex items-center gap-1.5 rounded-lg border border-line bg-panel px-3 py-1.5 font-mono text-[0.625rem] uppercase tracking-[0.1em] text-muted transition-colors hover:text-foreground"}
    >
